...
export default async function Page({ params, searchParams }) {
  // Await searchParams for proper access
  const { page } = await searchParams;  // Await searchParams here
  const currentPage = parseInt(page) || 1;  // Ensure we are parsing page correctly

  // Await params for proper access to slug
